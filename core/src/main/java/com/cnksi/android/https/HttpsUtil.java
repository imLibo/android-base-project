 ...
 */
package com.cnksi.android.https;
...
public class HttpsUtil {
     ...
     * 获取证书
     */
    public static HttpsUtil.SSLParams getSSLParams(Context mContext, String bksName, String password) {
        HttpsUtil.SSLParams sslParams = null;
        try {
            InputStream bksFile = mContext.getAssets().open(bksName);
            sslParams = HttpsUtil.getSslSocketFactory(bksFile, password, (X509TrustManager) null);
        } catch (Exception e) {
            KLog.e(e);
        }
        return sslParams;
     ...
     * 获取证书
     */
    public static HttpsUtil.SSLParams getSSLParamsWithCA(Context mContext, String bksName, String cerName, String password) {
        HttpsUtil.SSLParams sslParams = null;
        try {
            InputStream bksFile = mContext.getAssets().open(bksName);
            InputStream certificates = mContext.getAssets().open(cerName);
            sslParams = HttpsUtil.getSslSocketFactory(bksFile, password, certificates);
        } catch (Exception e) {
            KLog.e(e);
        }
        return sslParams;
