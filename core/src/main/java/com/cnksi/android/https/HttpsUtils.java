...
public class HttpsUtils {
     ...
     * 获取证书
     */
    public static HttpsUtils.SSLParams getSSLParams(Context mContext, String bksName, String password) {
        HttpsUtils.SSLParams sslParams = null;
        try {
            InputStream bksFile = mContext.getAssets().open(bksName);
            sslParams = HttpsUtils.getSslSocketFactory(bksFile, password, (X509TrustManager) null);
        } catch (Exception e) {
            KLog.e(e);
        }
        return sslParams;
     ...
     * 获取证书
     */
    public static HttpsUtils.SSLParams getSSLParamsWithCA(Context mContext, String bksName, String cerName, String password) {
        HttpsUtils.SSLParams sslParams = null;
        try {
            InputStream bksFile = mContext.getAssets().open(bksName);
