...
public class SqlInfoBuilder {
    ...
    public static SqlInfo buildUpdateSqlInfo(DbUtils db, Class<?> entityType, WhereBuilder whereBuilder, String[] updateColumnNames, String[] updateColumnValues) throws DbException {
        ...
        for(int count = updateColumnNames.length; i < count; ++i) {
            sqlBuffer.append(updateColumnNames[i]).append("=?,");
            result.addBindArgWithoutConverter(updateColumnValues[i]);
        }
