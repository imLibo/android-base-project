...
import com.cnksi.sample.databinding.LablevalueLayoutBinding;
 ...
 * @since 1.0
 */
public class LabelValueLayoutDialog extends BaseDialog {

    private LablevalueLayoutBinding mBinding;
    ...
    protected View getContentView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container) {
        mBinding = DataBindingUtil.inflate(inflater, R.layout.lablevalue_layout, container, false);
...
//        params.windowAnimations = R.style.dialog_animation;
    ...
    protected void initView() {
        super.initView();
        mBinding.labelValueContainer.setDrawableOnClickListener(v -> Toasty.info(getContext(), mBinding.labelValueContainer.getValueText().toString()).show());
    }
}
